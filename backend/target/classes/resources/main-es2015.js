...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "Essai", function() { return Essai; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ResultatFeedBack", function() { return ResultatFeedBack; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");

class ResultatFeedBack {
    constructor() {
        this.essai = 0.0;
        this.reussi = false;
        this.listError = [];
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ResultatUser", function() { return ResultatUser; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
...
/* harmony import */ var _beans_Deplacement__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./beans/Deplacement */ "./src/app/@serie/beans/Deplacement.ts");
/* harmony import */ var _beans_Essai__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./beans/Essai */ "./src/app/@serie/beans/Essai.ts");
/* harmony import */ var _beans_ResultatFeedBack__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./beans/ResultatFeedBack */ "./src/app/@serie/beans/ResultatFeedBack.ts");
/* harmony import */ var _beans_ResultatUser__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./beans/ResultatUser */ "./src/app/@serie/beans/ResultatUser.ts");
...
let SerieComponent = class SerieComponent {
    constructor(_serieService, _modalService) {
        ...
        this.resultUser = new _beans_ResultatUser__WEBPACK_IMPORTED_MODULE_10__["ResultatUser"]();
    ...
    addUser(modal) {
        ...
        this._serieService.addUser(this._newUtilisateur).subscribe((resultat) => {
    ...
    selectScenario(scenario, elementid) {
        ...
        this._nbAction = 1;
        //recup position tableau
        this.tableau = document.getElementById(elementid);
    ...
    addDeplacement(event) {
        ...
        this._serieService.getDepalcementList(this._scenarioplay.id).subscribe(res => {
            this._depalcementList = res;
        });
    ...
    lanceFeedBack() {
        ...
        this._serieService.addEssai(this._newEssai).subscribe((resultat) => {

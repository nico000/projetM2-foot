...
let SerieComponent = class SerieComponent {
    ...
    lance_simu() {
        this._isLancer = true;
        const nbVisualisation = this._serieSelect.experience[this._scenarioLancer].visuFeedback;
        let visualisationCounter = 0;
        this._nbVisualisation = 1;
        const lanceVisuWithDelay = () => {
            if (visualisationCounter < nbVisualisation) {
                this.lance_visu(); // Appel de la fonction lance_visu()
